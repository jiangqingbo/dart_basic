...
//  int i2 = int.tryParse('1.0');//返回null
  ...
  var names = 'jiangqingbo ${name}';
  var rawNames = r'jiangqingbo ${name}'; //r 前缀可以创建一个 “原始 raw” 字符串
  print('names: ${names}');
...
//  List growableList = new List()..length = 3;
  ...
  print('map :${map}');
  //也可以这样声明
  var map1 = {'name': 'jiangqingbo', 1: 'android'};
  map1.addAll({'name':'bobo'});
  print('map1 :${map1}');
  //常用属性
...
//  print(map.values); //value集合
  ...
  //常用方法 增删改查与list类似
  var set1 = {'jiangqingbo', 'flutter'};
  print('set1 :${set1}');
  var set2 = {'jiangqingbo', 'bobo', 'dart'};
  print('set2 :${set2}');
